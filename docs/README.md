...
本目录用于存放 `卡厄思梦境 PC 自动化项目` 的规划、技术设计、验证报告与决策记录。

## 当前文档

- [czn-pc-automation-plan.md](/Users/michael/Documents/MaaLearn/docs/czn-pc-automation-plan.md)：项目开发计划、里程碑、技术方向、交付物与文档策略。
- [specs/architecture.md](/Users/michael/Documents/MaaLearn/docs/specs/architecture.md)：系统分层、MaaFramework 的角色、Python 原型的定位与后续迁移策略。
- [specs/development-workflow.md](/Users/michael/Documents/MaaLearn/docs/specs/development-workflow.md)：开发顺序、阶段拆分、日志与实时进度要求。
- [specs/event-system.md](/Users/michael/Documents/MaaLearn/docs/specs/event-system.md)：事件页识别、2-4 选项解析、已知事件配置表与未知事件兜底策略设计。
- [specs/roguelike-flow.md](/Users/michael/Documents/MaaLearn/docs/specs/roguelike-flow.md)：肉鸽阶段的状态拆分、策略边界、MVP 范围与推荐实现顺序。
...
- 后续新增文档默认使用中文。
- 重要技术决策应先写入文档，或与实现同步更新。
- 优先补充既有文档，避免创建语义重复的说明文件。
- 涉及时间敏感信息时，使用明确日期记录。
- 技术验证类文档应包含结论、风险与下一步动作。
